...
namespace ADOForm
{
    public class DBClass //DBClass 정의 시작
    {
        ...
        public DataTable MyclassTable
        {
            get { return myclassTable; }
            set
            {
                myclassTable = value;
            }
        ...
        public DataTable SearchmyclassTable
        {
            get { return searchmyclassTable; }
            set
            {
                searchmyclassTable = value;
            }
        }
        ...
        public void DB_Open()
        {
            try
            {
                string connectionString = "User Id=swim; Password = 1111; Data Source = (DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA = (SERVER = DEDICATED)(SERVICE_NAME = xe))); ";
        ...
        public void DB_Open_myclass()
        {
            ...
            {
                string connectionString = "User Id=swim; Password = 1111; Data Source = (DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA = (SERVER = DEDICATED)(SERVICE_NAME = xe))); ";
                string commandString = "select * from myclass";
                DBAdapter = new
               OracleDataAdapter(commandString, connectionString);
                MyCommandBuilder = new
               OracleCommandBuilder(DBAdapter);
        ...
        public void DB_Open_searchmyclass()
        {
            ...
            {
                string connectionString = "User Id=swim; Password = 1111; Data Source = (DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA = (SERVER = DEDICATED)(SERVICE_NAME = xe))); ";
                string commandString = "select m.mem_id, c.cl_id, my.mycl_id from member m, class c, myclass my WHERE m.mem_id = my.mem_id AND m.mem_id = '{mem_id}'";
                DBAdapter = new
               OracleDataAdapter(commandString, connectionString);
                MyCommandBuilder = new
               OracleCommandBuilder(DBAdapter);
        ...
        public void DB_Access()
        {
            try
            {
                string My_con = "User Id=swim; Password=1111; Data Source=(DESCRIPTION =   (ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))   (CONNECT_DATA =     (SERVER = DEDICATED)     (SERVICE_NAME = xe)   ) );";
